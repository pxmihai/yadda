    ...
    <div class="row">
        <div class="one-half column" style="margin-top: 25%">
            ...
            <!--<p>This index.html page is a placeholder with the CSS, font and favicon.
             It's just waiting for you to add some content! If you need some help hit up
             the <a href="http://www.getskeleton.com">Skeleton documentation</a>.</p> -->

        <p>This is the placeholder for an app. It's goal is to summarize text.<br>
        This website as of now is being build in Intellij IDEA. <br>
            ...
            <br>
            Note: The extra <b>d</b> was added because <b>yada</b> was not available
