package yaddaSpace.helpers;

public class dataField {

    public static String text0="Cica erau odata o baba si un mosneag: mosneagul de-o suta de ani, si baba de nouazeci; si amândoi batrânii acestia erau albi ca iarna si posomorâti ca vremea cea rea din pricina ca nu aveau copii. si, Doamne! tare mai erau doriti sa aiba macar unul, caci, cât era ziulica si noaptea de mare, sedeau singurei ca cucul si le tiuiau urechile, de urât ce le era. si apoi, pe lânga toate aceste, nici vreo scofala mare nu era de dânsii: un bordei ca vai de el, niste toale rupte, asternute pe laite, si atâta era tot. Ba de la o vreme încoace, urâtul îi mânca si mai tare, caci tipenie de om nu le deschidea usa; parca erau bolnavi de ciuma, sarmanii! ";
